...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function() {
        ...
        $('.nav-w-submenu-container .nav-vertical li a').click(function(e) {
          e.preventDefault();
          var navElem = $(e.target).parents('li');
          var submenuName = navElem.attr('data-for');
          if (submenuName === activeSubmenu) {
            $('.' + submenuName).toggleClass('active');
            return;
          } else {
            navElem.parent('ul').find('li a').removeClass('active');
            navElem.find('a').addClass('active');
            $('.nav-w-submenu-container .nav-vertical-submenu').removeClass('active');
